...
export declare class Classroom extends Document {
    name: string;
    groups: string[];
}
export declare const ClassroomSchema: mongoose.Schema<Classroom, mongoose.Model<Classroom, any, any, any, mongoose.Document<unknown, any, Classroom> & Classroom & {
    _id: mongoose.Types.ObjectId;
}, any>, {}, {}, {}, {}, mongoose.DefaultSchemaOptions, Classroom, mongoose.Document<unknown, {}, mongoose.FlatRecord<Classroom>> & mongoose.FlatRecord<Classroom> & {
    _id: mongoose.Types.ObjectId;
}>;
